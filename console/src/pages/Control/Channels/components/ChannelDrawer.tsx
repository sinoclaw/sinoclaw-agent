...
// Doc EN URLs per channel (anchors on https://sinoclaw.agentscope.io/docs/channels)
const CHANNEL_DOC_EN_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk:
    "https://sinoclaw.agentscope.io/docs/channels/?lang=en#DingTalk-recommended",
  feishu: "https://sinoclaw.agentscope.io/docs/channels/?lang=en#Feishu-Lark",
  imessage:
    "https://sinoclaw.agentscope.io/docs/channels/?lang=en#iMessage-macOS-only",
  discord: "https://sinoclaw.agentscope.io/docs/channels/?lang=en#Discord",
  qq: "https://sinoclaw.agentscope.io/docs/channels/?lang=en#QQ",
  telegram: "https://sinoclaw.agentscope.io/docs/channels/?lang=en#Telegram",
  mqtt: "https://sinoclaw.agentscope.io/docs/channels/?lang=en#MQTT",
  mattermost: "https://sinoclaw.agentscope.io/docs/channels/?lang=en#Mattermost",
  matrix: "https://sinoclaw.agentscope.io/docs/channels/?lang=en#Matrix",
  wecom:
    "https://sinoclaw.agentscope.io/docs/channels/?lang=en#WeCom-WeChat-Work",
  weixin:
    "https://sinoclaw.agentscope.io/docs/channels/?lang=en#WeChat-Personal-iLink",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
  onebot:
    "https://sinoclaw.agentscope.io/docs/channels/?lang=en#OneBot-v11-NapCat--QQ-full-protocol",
};

// Doc ZH URLs per channel (anchors on https://sinoclaw.agentscope.io/docs/channels)
const CHANNEL_DOC_ZH_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#钉钉推荐",
  feishu: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#飞书",
  imessage:
    "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#iMessage仅-macOS",
  discord: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#Discord",
  qq: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#QQ",
  telegram: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#Telegram",
  mqtt: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#MQTT",
  mattermost: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#Mattermost",
  matrix: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#Matrix",
  wecom: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#企业微信",
  weixin: "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#微信个人iLink",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
  onebot:
    "https://sinoclaw.agentscope.io/docs/channels/?lang=zh#OneBot-v11NapCat--QQ-完整协议",
};
        ...
        return (
          <>
            ...
            <Form.Item name="media_dir" label={t("channels.weixinMediaDir")}>
              <Input placeholder="~/.sinoclaw/media" />
            </Form.Item>
          </>
        );
      ...
      case "mattermost":
        return (
          <>
            ...
            <Form.Item name="media_dir" label={t("channels.weixinMediaDir")}>
              <Input placeholder="~/.sinoclaw/media/mattermost" />
            </Form.Item>
            <Form.Item
              name="show_typing"
              label="Show Typing"
      ...
      case "weixin":
        return (
          <>
            ...
            >
              <Input placeholder="~/.sinoclaw/weixin_bot_token" />
            </Form.Item>
            <Form.Item name="media_dir" label={t("channels.weixinMediaDir")}>
              <Input placeholder="~/.sinoclaw/media" />
            </Form.Item>
          ...
          <Button
            ...
            onClick={() => {
              const url =
                CHANNEL_DOC_EN_URLS[activeKey]! ||
                CHANNEL_DOC_ZH_URLS[activeKey]!;
              const isSinoclawDoc = url.includes(
                "sinoclaw.agentscope.io/docs/channels/",
              );
              const finalUrl =
                isSinoclawDoc && currentLang === "zh"
                  ? CHANNEL_DOC_ZH_URLS[activeKey]!
                  : CHANNEL_DOC_EN_URLS[activeKey]!;
