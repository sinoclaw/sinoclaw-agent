"""Tests for the specifier module + `sinoclaw kanban specify` CLI surface.
...
from sinoclaw_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `sinoclaw kanban …` argparse surface directly."""
