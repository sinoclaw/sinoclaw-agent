...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch sinoclaw_cli.plugins.get_plugin_commands() to a fixed dict."""
        from sinoclaw_cli import plugins as _plugins_mod
    ...
    def test_is_gateway_known_command_recognizes_plugin_commands(self, monkeypatch):
        ...
        from sinoclaw_cli.commands import is_gateway_known_command
