"""Tests for sinoclaw_cli/goals.py — persistent cross-turn goals."""
...
def sinoclaw_home(tmp_path, monkeypatch):
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves SINOCLAW_HOME.
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from sinoclaw_cli.goals import _parse_judge_response
...
class TestJudgeGoal:
    def test_empty_goal_skipped(self):
        from sinoclaw_cli.goals import judge_goal
...
class TestGoalManager:
    def test_no_goal_initial(self, sinoclaw_home):
    ...
    def test_set_then_status(self, sinoclaw_home):
        from sinoclaw_cli.goals import GoalManager
    ...
    def test_set_rejects_empty(self, sinoclaw_home):
        from sinoclaw_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, sinoclaw_home):
        from sinoclaw_cli.goals import GoalManager
    ...
    def test_clear(self, sinoclaw_home):
        from sinoclaw_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, sinoclaw_home):
    ...
    def test_evaluate_after_turn_done(self, sinoclaw_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, sinoclaw_home):
        from sinoclaw_cli import goals
        from sinoclaw_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, sinoclaw_home):
    ...
    def test_evaluate_after_turn_inactive(self, sinoclaw_home):
    ...
    def test_continuation_prompt_shape(self, sinoclaw_home):
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from sinoclaw_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, sinoclaw_home):
        """N=3 consecutive parse failures → auto-pause with config pointer."""
        from sinoclaw_cli import goals
        from sinoclaw_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, sinoclaw_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, sinoclaw_home):
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from sinoclaw_cli import goals
        from sinoclaw_cli.goals import GoalManager, load_goal
