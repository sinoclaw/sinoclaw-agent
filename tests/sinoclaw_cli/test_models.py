...
class TestFetchOpenRouterModels:
    ...
    def test_filters_out_models_without_tool_support(self, monkeypatch):
        ...
        sinoclaw-agent is tool-calling-first — surfacing a non-tool model leads to
...
class TestOpenRouterToolSupportHelper:
    ...
    def test_tools_in_supported_parameters(self):
        from sinoclaw_cli.models import _openrouter_model_supports_tools
...
class TestNousRecommendedModels:
    ...
    def test_fetch_caches_per_portal_url(self):
        from sinoclaw_cli.models import fetch_nous_recommended_models
    ...
    def test_get_aux_model_returns_vision_recommendation(self):
        ...
        with patch(
            "sinoclaw_cli.models.fetch_nous_recommended_models",
    ...
    def test_get_aux_model_returns_none_on_empty_payload(self):
        from sinoclaw_cli.models import get_nous_recommended_aux_model
        with patch("sinoclaw_cli.models.fetch_nous_recommended_models", return_value={}):
    ...
    def test_paid_tier_prefers_paid_recommendation(self):
        ...
        with patch("sinoclaw_cli.models.fetch_nous_recommended_models", return_value=payload):
    ...
    def test_auto_detects_tier_when_not_supplied(self):
        ...
        with (
            patch("sinoclaw_cli.models.fetch_nous_recommended_models", return_value=payload),
            patch("sinoclaw_cli.models.check_nous_free_tier", return_value=True),
        ):
            assert get_nous_recommended_aux_model(vision=False) == "free-model"
        with (
            patch("sinoclaw_cli.models.fetch_nous_recommended_models", return_value=payload),
            patch("sinoclaw_cli.models.check_nous_free_tier", return_value=False),
        ):
    ...
    def test_tier_detection_error_defaults_to_paid(self):
        ...
        with (
            patch("sinoclaw_cli.models.fetch_nous_recommended_models", return_value=payload),
            patch("sinoclaw_cli.models.check_nous_free_tier", side_effect=RuntimeError("boom")),
        ):
            assert get_nous_recommended_aux_model(vision=False) == "paid-model"
