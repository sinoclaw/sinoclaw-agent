...
class TestProviderModelIds:
    ...
    def test_copilot_falls_back_to_curated_defaults_without_stale_opus(self):
        with patch("sinoclaw_cli.models._resolve_copilot_catalog_api_key", return_value="gh-token"), \
...
class TestValidateApiFallback:
    ...
    def test_known_model_accepted_via_catalog_when_api_down(self):
        ...
        with patch(
            "sinoclaw_cli.models.provider_model_ids",
    ...
    def test_unknown_provider_soft_accepted_when_api_down(self):
        ...
        with patch("sinoclaw_cli.models.provider_model_ids", return_value=[]):
    ...
    def test_fetch_lmstudio_models_filters_embedding_type(self):
        ...
        with patch("sinoclaw_cli.models.urllib.request.urlopen", return_value=mock_resp):
    ...
    def test_fetch_lmstudio_models_raises_auth_error_on_401(self):
        ...
        with patch("sinoclaw_cli.models.urllib.request.urlopen", side_effect=http_error):
    ...
    def test_fetch_lmstudio_models_returns_empty_on_network_error(self):
        with patch(
            "sinoclaw_cli.models.urllib.request.urlopen",
...
class TestProbeApiModelsUserAgent:
    """Probing custom /v1/models must send a Sinoclaw User-Agent.
    ...
    def test_probe_sends_sinoclaw_user_agent(self):
        ...
        assert ua.startswith("sinoclaw-cli/"), (
            f"User-Agent must advertise sinoclaw-cli, got {ua!r}"
        )
    ...
    def test_probe_user_agent_sent_without_api_key(self):
        ...
        assert ua and ua.startswith("sinoclaw-cli/")
