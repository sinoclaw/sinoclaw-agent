...
def session_db(tmp_path):
    ...
    os.environ["SINOCLAW_HOME"] = str(tmp_path / ".hermes")
...
def cli_instance(tmp_path, session_db):
    """Create a minimal SinoclawCLI-like object for testing _handle_branch_command."""
...
class TestBranchCommandCLI:
    ...
    def test_branch_creates_new_session(self, cli_instance, session_db):
        ...
        SinoclawCLI._handle_branch_command(cli_instance, "/branch")
    ...
    def test_branch_with_custom_name(self, cli_instance, session_db):
        ...
        SinoclawCLI._handle_branch_command(cli_instance, "/branch refactor approach")
