...
code paths Sinoclaw takes on native Windows.
...
class TestConfigureWindowsStdio:
    ...
    - respect SINOCLAW_DISABLE_WINDOWS_UTF8 opt-out
    """
    ...
    def test_windows_path_sets_env_and_reconfigures_streams(self, monkeypatch):
        ...
        monkeypatch.delenv("SINOCLAW_DISABLE_WINDOWS_UTF8", raising=False)
...
class TestCodeExecutionTransportTcpFallback:
    ...
    AF_INET endpoints based on the SINOCLAW_RPC_SOCKET format.
    """
