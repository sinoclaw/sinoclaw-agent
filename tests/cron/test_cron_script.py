...
def cron_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(jobs_mod, "HERMES_DIR", sinoclaw_home)
...
class TestRunJobEnvVarCleanup:
    ...
    def test_env_vars_cleaned_on_early_error(self, cron_env, monkeypatch):
        ...
        assert os.environ.get("SINOCLAW_SESSION_PLATFORM") is None
        assert os.environ.get("SINOCLAW_SESSION_CHAT_ID") is None
        assert os.environ.get("SINOCLAW_SESSION_CHAT_NAME") is None
