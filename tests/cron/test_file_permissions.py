...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("sinoclaw_cli.config.get_config_path", return_value=config_path), \
             patch("sinoclaw_cli.config.ensure_sinoclaw_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("sinoclaw_cli.config.get_env_path", return_value=env_path), \
             patch("sinoclaw_cli.config.ensure_sinoclaw_home"):
