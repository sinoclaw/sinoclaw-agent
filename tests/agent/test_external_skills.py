...
class TestGetExternalSkillsDirs:
    ...
    def test_nonexistent_dir_skipped(self, sinoclaw_home):
    ...
    def test_valid_dir_returned(self, sinoclaw_home, external_skills_dir):
        (sinoclaw_home / "config.yaml").write_text(
            f"skills:\n  external_dirs:\n    - {external_skills_dir}\n"
        )
        with patch.dict(os.environ, {"HERMES_HOME": str(sinoclaw_home)}):
    ...
    def test_duplicate_dirs_deduplicated(self, sinoclaw_home, external_skills_dir):
        (sinoclaw_home / "config.yaml").write_text(
            f"skills:\n  external_dirs:\n    - {external_skills_dir}\n    - {external_skills_dir}\n"
        )
        with patch.dict(os.environ, {"HERMES_HOME": str(sinoclaw_home)}):
    ...
    def test_local_skills_dir_excluded(self, sinoclaw_home):
    ...
    def test_string_value_converted_to_list(self, sinoclaw_home, external_skills_dir):
        (sinoclaw_home / "config.yaml").write_text(
...
class TestGetAllSkillsDirs:
    def test_local_always_first(self, sinoclaw_home, external_skills_dir):
        (sinoclaw_home / "config.yaml").write_text(
            f"skills:\n  external_dirs:\n    - {external_skills_dir}\n"
        )
        with patch.dict(os.environ, {"HERMES_HOME": str(sinoclaw_home)}):
...
class TestExternalSkillsInFindAll:
    def test_external_skills_found(self, sinoclaw_home, external_skills_dir):
        (sinoclaw_home / "config.yaml").write_text(
            f"skills:\n  external_dirs:\n    - {external_skills_dir}\n"
        )
        local_skills = sinoclaw_home / "skills"
    ...
    def test_local_takes_precedence(self, sinoclaw_home, external_skills_dir):
...
class TestExternalSkillView:
    def test_skill_view_finds_external(self, sinoclaw_home, external_skills_dir):
        (sinoclaw_home / "config.yaml").write_text(
            f"skills:\n  external_dirs:\n    - {external_skills_dir}\n"
        )
        local_skills = sinoclaw_home / "skills"
