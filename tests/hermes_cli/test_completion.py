"""Tests for sinoclaw_cli/completion.py — shell completion script generation."""
...
from sinoclaw_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
def _make_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(prog="sinoclaw")
...
class TestGenerateBash:
    def test_contains_completion_function_and_register(self):
        ...
        assert "complete -F _sinoclaw_completion sinoclaw" in out
...
class TestGenerateZsh:
    def test_contains_compdef_header(self):
        ...
        assert "#compdef sinoclaw" in out
...
class TestProfileCompletion:
    ...
    def test_bash_profile_actions_complete_profile_names(self):
        """After 'sinoclaw profile use', complete with profile names."""
        out = generate_bash(_make_parser())
