...
try:
    from sinoclaw_cli import __version__ as HERMES_VERSION
except Exception:
...
class SinoclawACPAgent(acp.Agent):
    ...
    async def _register_session_mcp_servers(
        ...
        try:
            ...
            enabled_toolsets = getattr(state.agent, "enabled_toolsets", None) or ["sinoclaw-acp"]
    ...
    async def initialize(
        ...
        **kwargs: Any,
        ...
        return InitializeResponse(
            ...
            agent_info=Implementation(name="sinoclaw-agent", version=HERMES_VERSION),
    ...
    def _cmd_model(self, args: str, state: SessionState) -> str:
        ...
        try:
            from sinoclaw_cli.models import parse_model_input, detect_provider_for_model
    ...
    def _cmd_tools(self, args: str, state: SessionState) -> str:
        try:
            from model_tools import get_tool_definitions
            toolsets = getattr(state.agent, "enabled_toolsets", None) or ["sinoclaw-acp"]
    ...
    def _cmd_version(self, args: str, state: SessionState) -> str:
        return f"Sinoclaw Agent v{HERMES_VERSION}"
