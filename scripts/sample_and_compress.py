...
DEFAULT_DATASETS = [
    ...
    "NousResearch/sinoclaw-agent-megascience-sft1",
    "NousResearch/Sinoclaw-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Sinoclaw-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-sinoclaw-agent"
]
