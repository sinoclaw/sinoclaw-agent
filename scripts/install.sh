...
print_success() {
    ...
    # Show file locations
    echo -e "${CYAN}${BOLD}📁 Your files (all in ~/.sinoclaw/):${NC}"
    echo ""
    echo -e "   ${YELLOW}Config:${NC}    ~/.sinoclaw/config.yaml"
    echo -e "   ${YELLOW}API Keys:${NC}  ~/.sinoclaw/.env"
    echo -e "   ${YELLOW}Data:${NC}      ~/.sinoclaw/cron/, sessions/, logs/"
    echo -e "   ${YELLOW}Code:${NC}      ~/.sinoclaw/sinoclaw-agent/"
    echo ""
