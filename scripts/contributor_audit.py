...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Sinoclaw\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "sinoclaw@nousresearch.com",
    "sinoclaw-audit@example.com",
    "sinoclaw@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/sinoclaw-agent",
                "--state", "merged",
