# Streaming LLM Response Support for Sinoclaw Agent
...
```
SINOCLAW_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SINOCLAW_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `sinoclaw_cli/config.py` | 1 | +streaming config defaults |
...
SINOCLAW_STREAMING_ENABLED=true
```
