...
Allows users to interact with Sinoclaw by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Sinoclaw Agent")
        ...
        msg_id = f"<sinoclaw-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
