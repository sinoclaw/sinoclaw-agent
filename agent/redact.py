...
# `export SINOCLAW_REDACT_SECRETS=false`) cannot disable redaction mid-session.
_REDACT_ENABLED = os.getenv("SINOCLAW_REDACT_SECRETS", "").lower() not in ("0", "false", "no", "off")
