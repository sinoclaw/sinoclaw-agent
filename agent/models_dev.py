...
Data resolution order (like TypeScript OpenCode):
  ...
  2. Disk cache (~/.sinoclaw/models_dev_cache.json)
...
def _get_cache_path() -> Path:
    ...
    return get_sinoclaw_home() / "models_dev_cache.json"
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Sinoclaw provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal Sinoclaw agent traffic.
