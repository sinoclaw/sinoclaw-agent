...
slug: /
sidebar_position: 0
title: "Sinoclaw Agent Documentation"
description: "The self-improving AI agent built by Sinoclaw Team. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Sinoclaw Team](https://github.com/sinoclaw). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/sinoclaw/sinoclaw-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
- **Built by model trainers** — Created by [Sinoclaw Team](https://github.com/sinoclaw), the lab behind Hermes, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Sinoclaw Team](https://github.com/sinoclaw) — the lab behind Hermes, Nomos, and Psyche models
