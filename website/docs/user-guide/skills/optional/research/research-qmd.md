...
| | |
|---|---|
| Source | Optional — install with `sinoclaw skills install official/research/qmd` |
...
Sinoclaw Agent via the native MCP client. This is the preferred
...
Then configure Sinoclaw Agent to connect via HTTP:
