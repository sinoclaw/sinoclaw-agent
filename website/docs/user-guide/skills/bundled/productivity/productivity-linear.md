...
The trailing hex segment is the `slugId`. Example: `https://linear.app/sinoclaw/document/rfc-sinoclaw-permission-gateway-discord-38359beef67c` → `slugId` is `38359beef67c`.
