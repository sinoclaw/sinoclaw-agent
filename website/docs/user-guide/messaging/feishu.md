...
|---------|---------|---------|
| Quiet period | `SINOCLAW_FEISHU_TEXT_BATCH_DELAY_SECONDS` | 0.6s |
| Max messages per batch | `SINOCLAW_FEISHU_TEXT_BATCH_MAX_MESSAGES` | 8 |
| Max characters per batch | `SINOCLAW_FEISHU_TEXT_BATCH_MAX_CHARS` | 4000 |
...
| Setting | Env Var | Default |
|---------|---------|---------|
| Quiet period | `SINOCLAW_FEISHU_MEDIA_BATCH_DELAY_SECONDS` | 0.8s |
...
| Setting | Env Var | Default |
|---------|---------|---------|
| Cache size | `SINOCLAW_FEISHU_DEDUP_CACHE_SIZE` | 2048 entries |
...
| `SINOCLAW_FEISHU_DEDUP_CACHE_SIZE` | — | `2048` | Max deduplicated message IDs to track |
| `SINOCLAW_FEISHU_TEXT_BATCH_DELAY_SECONDS` | — | `0.6` | Text burst debounce quiet period |
| `SINOCLAW_FEISHU_TEXT_BATCH_MAX_MESSAGES` | — | `8` | Max messages merged per text batch |
| `SINOCLAW_FEISHU_TEXT_BATCH_MAX_CHARS` | — | `4000` | Max characters merged per text batch |
| `SINOCLAW_FEISHU_MEDIA_BATCH_DELAY_SECONDS` | — | `0.8` | Media burst debounce quiet period |
