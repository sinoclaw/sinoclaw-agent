...
The built-in web dashboard runs as an optional side-process inside the same container as the gateway. Set `SINOCLAW_DASHBOARD=1` and expose port `9119` alongside the gateway's `8642`:
