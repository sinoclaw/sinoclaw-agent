...
Lists the agent as an available model. The advertised model name defaults to the [profile](/docs/user-guide/profiles) name (or `sinoclaw-agent` for the default profile). Required by most frontends for model discovery.
