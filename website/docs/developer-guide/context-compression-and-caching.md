...
Sinoclaw Agent uses a dual compression system and Anthropic prompt caching to
...
Configure via `sinoclaw plugins` → Provider Plugins → Context Engine, or edit `config.yaml` directly.
