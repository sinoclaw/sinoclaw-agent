...
| [`sinoclaw-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sinoclaw-agent) | Configure, extend, or contribute to Sinoclaw Agent. | `autonomous-ai-agents/sinoclaw-agent` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-sinoclaw-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-sinoclaw-tui-commands) | Debug Hermes TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-sinoclaw-tui-commands` |
| [`sinoclaw-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-sinoclaw-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/sinoclaw-agent-skill-authoring` |
