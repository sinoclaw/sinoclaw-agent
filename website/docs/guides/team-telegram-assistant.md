...
sinoclaw pairing revoke telegram 987654321
...
For a full guide, see [Use SOUL.md with Hermes](/docs/guides/use-soul-with-sinoclaw).
...
```bash
# From the CLI
sinoclaw cron list          # View all scheduled jobs
sinoclaw cron status        # Check if scheduler is running
