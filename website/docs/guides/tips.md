...
Want Hermes to have a stable default voice? Edit `~/.sinoclaw/SOUL.md` (or `$SINOCLAW_HOME/SOUL.md` if you use a custom Sinoclaw home). Hermes now seeds a starter SOUL automatically and uses that global file as the instance-wide personality source.
