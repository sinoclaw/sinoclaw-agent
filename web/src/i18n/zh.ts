...
export const zh: Translations = {
  ...
  status: {
    ...
    stopped: "已停止",
    updateSinoclaw: "更新 Sinoclaw",
    updatingSinoclaw: "正在更新 Sinoclaw…",
  ...
  pluginsPage: {
    ...
    removeConfirm: "从 ~/.sinoclaw/plugins/ 删除此插件？",
    removeHint: "仅可移除用户安装在 ~/.sinoclaw/plugins 下的插件。",
  ...
  skills: {
    ...
    categories: "分类",
    filters: "筛选",
    noSkills: "未找到技能。技能从 ~/.sinoclaw/skills/ 加载",
