 ...
 * `window.__SINOCLAW_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Sinoclaw brand in the top bar
 ...
 *  `window.__SINOCLAW_PLUGINS__.registerSlot(...)`.
 *
