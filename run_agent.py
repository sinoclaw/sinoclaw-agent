...
class AIAgent:
            ...
            if api_key and base_url:
                ...
                if "openrouter" in effective_base.lower():
                    client_kwargs["default_headers"] = {
                        ...
                        "X-OpenRouter-Title": "Sinoclaw Agent",
                ...
                if not _mem_provider_name:
                    try:
                        ...
                        if _hcfg.enabled and (_hcfg.api_key or _hcfg.base_url):
                            ...
                            try:
                                from sinoclaw_cli.config import load_config as _lc, save_config as _sc
                                _cfg = _lc()
                ...
                if _mem_provider_name:
                    ...
                    if self._memory_manager.providers:
                        ...
                        try:
                            ...
                            _init_kwargs["agent_workspace"] = "sinoclaw"
                        except Exception:
                            pass
    ...
    def _interruptible_api_call(self, api_kwargs: dict):
        ...
        _stale_base = float(os.getenv("SINOCLAW_API_CALL_STALE_TIMEOUT", 300.0))
    ...
    def _interruptible_streaming_api_call(
        ...
        def _call_chat_completions():
            ...
            import httpx as _httpx
            _base_timeout = float(os.getenv("SINOCLAW_API_TIMEOUT", 1800.0))
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        api_kwargs = {
            ...
            "timeout": float(os.getenv("SINOCLAW_API_TIMEOUT", 1800.0)),
        }
        if self._is_qwen_portal():
            api_kwargs["metadata"] = {
                "sessionId": self.session_id or "sinoclaw",
        ...
        if _is_nous:
            extra_body["tags"] = ["product=sinoclaw-agent"]
