...
```bash
sinoclaw skills browse               # browse all skills, official shown first
sinoclaw skills browse --source official  # browse only official optional skills
sinoclaw skills search <query>       # finds optional skills labeled "official"
sinoclaw skills install <identifier> # copies to ~/.sinoclaw/skills/ and activates
```
