"""
Timezone-aware clock for Sinoclaw.
...
Invalid timezone values log a warning and fall back safely — Sinoclaw never
...
from sinoclaw_constants import get_config_path
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Sinoclaw requires 3.9+)
