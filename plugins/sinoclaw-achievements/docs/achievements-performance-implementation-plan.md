...
- Snapshot persisted at `~/.sinoclaw/plugins/sinoclaw-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.sinoclaw/plugins/sinoclaw-achievements/scan_checkpoint.json`.
