...
- persisted runtime files:
  - `~/.sinoclaw/plugins/sinoclaw-achievements/state.json` (existing unlock state)
  - `~/.sinoclaw/plugins/sinoclaw-achievements/scan_snapshot.json` (new)
  - `~/.sinoclaw/plugins/sinoclaw-achievements/scan_checkpoint.json` (new)
