...
Owner: sinoclaw-achievements plugin
...
### `GET /api/plugins/sinoclaw-achievements/achievements`
...
### `POST /api/plugins/sinoclaw-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/sinoclaw-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/sinoclaw-achievements/overview`
...
- Persist plugin data under:
  - `~/.sinoclaw/plugins/sinoclaw-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.sinoclaw/plugins/sinoclaw-achievements/scan_checkpoint.json`
...
- `~/.sinoclaw/plugins/sinoclaw-achievements/`
