...
class HonchoSessionManager:
    ...
    Runs alongside sinoclaw' existing SQLite state and file-based memory,
    ...
    def dialectic_query(
        ...
        try:
            ...
            # Apply Sinoclaw-side char cap before caching
    ...
    def get_prefetch_context(self, session_key: str, user_message: str | None = None) -> dict[str, str]:
        ...
        # Also fetch AI peer's own representation so Sinoclaw knows itself.
        try:
