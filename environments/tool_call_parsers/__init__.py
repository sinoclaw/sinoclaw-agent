...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("sinoclaw")
        class SinoclawToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "sinoclaw", "mistral", "llama3_json")
...
from environments.tool_call_parsers.sinoclaw_parser import SinoclawToolCallParser  # noqa: E402, F401
