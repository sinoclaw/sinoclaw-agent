...
def run_doctor(args):
    ...
    try:
        from sinoclaw_cli.auth import get_nous_auth_status, get_codex_auth_status
    ...
    # =========================================================================
    # Check: Command installation (sinoclaw bin symlink)
    # =========================================================================
        ...
        if _venv_bin is None:
            ...
            if _cmd_link.is_symlink():
                ...
                check_fail(
                    ...
                    "(sinoclaw command may not work outside the venv)"
                )
                if should_fix:
...
<<<<<<< HEAD:sinoclaw_cli/doctor.py
                print(f"\r  {color('⚠', Colors.YELLOW)} {_label} {color('(boto3 not installed — pip install sinoclaw-agent[bedrock])', Colors.DIM)}           ")
                issues.append("Install boto3 for Bedrock: pip install sinoclaw-agent[bedrock]")
=======
...
>>>>>>> upstream/main:hermes_cli/doctor.py
            except Exception as _e:
    ...
    if not _active_memory_provider:
        ...
        try:
            ...
            if not _honcho_cfg_path.exists():
                ...
                issues.append("No Honcho API key — run 'sinoclaw memory setup'")
            else:
