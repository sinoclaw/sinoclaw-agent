...
try:
    ...
    raise SystemExit(
        ...
        "Run 'sinoclaw web' to auto-install, or: pip install sinoclaw-agent[web]"
    )
...
_OAUTH_PROVIDER_CATALOG: tuple[Dict[str, Any], ...] = (
    {
        ...
        "flow": "pkce",
        "cli_command": "sinoclaw auth add anthropic",
    ...
    },
    {
        ...
        "flow": "device_code",
        "cli_command": "sinoclaw auth add openai-codex",
    ...
    },
    {
        ...
        "flow": "external",
        "cli_command": "sinoclaw auth add qwen-oauth",
    ...
    for plugin in _get_dashboard_plugins():
        ...
        try:
            spec = importlib.util.spec_from_file_location(
                f"sinoclaw_dashboard_plugin_{plugin['name']}", api_path,
            )
