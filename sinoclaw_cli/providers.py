"""
Single source of truth for provider identity in Sinoclaw Agent.
...
2. **Sinoclaw overlays** — transport type, auth patterns, aggregator flags,
...
# -- Sinoclaw overlay ----------------------------------------------------------
# Sinoclaw-specific metadata that models.dev doesn't provide.

@dataclass(frozen=True)
class SinoclawOverlay:
    """Sinoclaw-specific provider metadata layered on top of models.dev."""
...
SINOCLAW_OVERLAYS: Dict[str, SinoclawOverlay] = {
    ...
    "nous": SinoclawOverlay(
        transport="openai_chat",
        auth_type="oauth_device_code",
        base_url_override="https://inference-api.nousresearch.com/v1",
    ),
    "openai-codex": SinoclawOverlay(
        transport="codex_responses",
        auth_type="oauth_external",
        base_url_override="https://chatgpt.com/backend-api/codex",
    ),
    "qwen-oauth": SinoclawOverlay(
        transport="openai_chat",
        auth_type="oauth_external",
        base_url_override="https://portal.qwen.ai/v1",
        base_url_env_var="SINOCLAW_QWEN_BASE_URL",
    ),
    "google-gemini-cli": SinoclawOverlay(
        transport="openai_chat",
        auth_type="oauth_external",
        base_url_override="cloudcode-pa://google",
    ),
    "lmstudio": SinoclawOverlay(
        transport="openai_chat",
        auth_type="api_key",
    ...
    "copilot-acp": SinoclawOverlay(
        transport="codex_responses",
        auth_type="external_process",
        base_url_override="acp://copilot",
        base_url_env_var="COPILOT_ACP_BASE_URL",
    ),
    "github-copilot": SinoclawOverlay(
        transport="openai_chat",
        extra_env_vars=("COPILOT_GITHUB_TOKEN", "GH_TOKEN"),
    ),
    "anthropic": SinoclawOverlay(
    ...
    "kimi-for-coding": SinoclawOverlay(
        transport="openai_chat",
        base_url_env_var="KIMI_BASE_URL",
    ),
    "stepfun": SinoclawOverlay(
        transport="openai_chat",
        extra_env_vars=("STEPFUN_API_KEY",),
        base_url_override="https://api.stepfun.ai/step_plan/v1",
        base_url_env_var="STEPFUN_BASE_URL",
    ),
    "minimax": SinoclawOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_BASE_URL",
    ),
    "minimax-oauth": SinoclawOverlay(
        transport="anthropic_messages",
        auth_type="oauth_external",
        base_url_override="https://api.minimax.io/anthropic",
    ),
    "minimax-cn": SinoclawOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_CN_BASE_URL",
    ),
    "deepseek": SinoclawOverlay(
        transport="openai_chat",
        base_url_env_var="DEEPSEEK_BASE_URL",
    ),
    "alibaba": SinoclawOverlay(
        transport="openai_chat",
        base_url_env_var="DASHSCOPE_BASE_URL",
    ),
    "alibaba-coding-plan": SinoclawOverlay(
        transport="openai_chat",
        base_url_env_var="ALIBABA_CODING_PLAN_BASE_URL",
    ),
    "vercel": SinoclawOverlay(
        transport="openai_chat",
        is_aggregator=True,
    ),
    "opencode": SinoclawOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="OPENCODE_ZEN_BASE_URL",
    ),
    "opencode-go": SinoclawOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="OPENCODE_GO_BASE_URL",
    ),
    "kilo": SinoclawOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="KILOCODE_BASE_URL",
    ),
    "huggingface": SinoclawOverlay(
        transport="openai_chat",
        is_aggregator=True,
    ...
    "nvidia": SinoclawOverlay(
        transport="openai_chat",
        base_url_override="https://integrate.api.nvidia.com/v1",
        base_url_env_var="NVIDIA_BASE_URL",
    ),
    "xiaomi": SinoclawOverlay(
        transport="openai_chat",
        base_url_env_var="XIAOMI_BASE_URL",
    ),
    "tencent-tokenhub": SinoclawOverlay(
        transport="openai_chat",
        base_url_env_var="TOKENHUB_BASE_URL",
    ),
    "arcee": SinoclawOverlay(
        transport="openai_chat",
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      1. Sinoclaw overlays (for providers not in models.dev: nous, openai-codex, etc.)
      2. models.dev catalog + Sinoclaw overlay
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + sinoclaw extra
    ...
    if overlay is not None:
        # Sinoclaw-only provider (not in models.dev)
        return ProviderDef(
            id=canonical,
