"""
Skills configuration for Sinoclaw Agent.
`sinoclaw skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.sinoclaw/config.yaml under:
...
from sinoclaw_cli.config import cfg_get, load_config, save_config
from sinoclaw_cli.colors import Colors, color
from sinoclaw_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `sinoclaw skills`."""
    from sinoclaw_cli.curses_ui import curses_checklist
