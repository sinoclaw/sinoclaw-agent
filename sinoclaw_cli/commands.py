...
def slack_subcommand_map() -> dict[str, str]:
    """Return subcommand -> /command mapping for Slack /sinoclaw handler.

    Maps both canonical names and aliases so /sinoclaw bg do stuff works
    the same as /sinoclaw background do stuff.
    """
    overrides = _resolve_config_gates()
