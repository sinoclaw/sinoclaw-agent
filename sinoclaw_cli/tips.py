...
TIPS = [
    ...
    # --- CLI Flags ---
    "sinoclaw -c resumes your most recent CLI session. sinoclaw -c \"project name\" resumes by title.",
    "sinoclaw -w creates an isolated git worktree — perfect for parallel agent workflows.",
    "sinoclaw -w -q \"Fix issue #42\" combines worktree isolation with a one-shot query.",
    ...
    "sinoclaw --yolo bypasses all dangerous command approval prompts for the entire session.",
    ...
    "sinoclaw -r SESSION_ID resumes any specific past session by its ID.",
    ...
    # --- Gateway & Messaging ---
    "Sinoclaw runs on 18 platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, email, and more.",
    ...
    "BOOT.md at ~/.sinoclaw/BOOT.md runs automatically on every gateway start — use it for startup checks.",
