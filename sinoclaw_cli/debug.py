...
<<<<<<< HEAD:sinoclaw_cli/debug.py
    ...
    script = (
        ...
        f"headers={{'User-Agent': 'sinoclaw-agent/auto-delete'}}), timeout=15) "
        f"for u in [{url_list}]]"
    )
...
>>>>>>> upstream/main:hermes_cli/debug.py
...
def _read_log_tail(log_name: str, num_lines: int) -> str:
    ...
    from sinoclaw_cli.logs import _read_last_n_lines
