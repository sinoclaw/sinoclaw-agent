...
`sinoclaw` provider-selection will pick up the change automatically.
"""
...
# this list:  sinoclaw model, /model, /provider, list_authenticated_providers.
#
# Fields:
...
_COPILOT_MODEL_ALIASES = {
    ...
    # Dash-notation fallbacks: Sinoclaw's default Claude IDs elsewhere use
