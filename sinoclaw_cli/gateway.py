...
>>>>>>> upstream/main:hermes_cli/gateway.py
    """
    pids: list[int] = []
    patterns = [
...
def _remap_path_for_user(path: str, target_home_dir: str) -> str:
    ...
    to *target_home_dir*; otherwise the path is returned unchanged.
      ...
      /opt/sinoclaw                 -> /opt/sinoclaw  (kept as-is)
...
def _sinoclaw_home_for_target_user(target_home_dir: str) -> str:
    ...
    root's home.  This translates it to the target user's equivalent path:
      ...
      /opt/custom-sinoclaw               → /opt/custom-sinoclaw  (kept as-is)
    """
    current_sinoclaw = get_sinoclaw_home().resolve()
...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            ...
            "2. Give it a username (e.g. sinoclaw) and copy the bot token",
    ...
    },
    {
        ...
        "vars": [
            {"name": "EMAIL_ADDRESS", "prompt": "Email address", "password": False,
             "help": "The email address Sinoclaw will use (e.g., sinoclaw@gmail.com)."},
        ...
        if var.get("is_allowlist"):
            ...
            if value:
                ...
                access_choices = [
                    ...
                    "Use DM pairing (unknown users request access, you approve with 'sinoclaw pairing approve')",
