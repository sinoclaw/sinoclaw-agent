        ...
        try:
            ...
            for line in content.split('\n'):
                ...
                if '# Sinoclaw Agent' in line or '# sinoclaw-agent' in line:
                    skip_next = True
                    continue
                if skip_next and ('sinoclaw' in line.lower() and 'PATH' in line):
                    skip_next = False
                    continue
                skip_next = False
                
                # Remove any PATH line containing sinoclaw
                if 'sinoclaw' in line.lower() and ('PATH=' in line or 'path=' in line.lower()):
                    continue
...
def uninstall_gateway_service():
    ...
    try:
<<<<<<< HEAD:sinoclaw_cli/uninstall.py
        from sinoclaw_cli.gateway import get_service_name
        svc_name = get_service_name()
    except Exception:
        svc_name = "sinoclaw-gateway"
...
>>>>>>> upstream/main:hermes_cli/uninstall.py
    except Exception as e:
...
<<<<<<< HEAD:sinoclaw_cli/uninstall.py
    # 5. Optionally remove ~/.sinoclaw/ data directory
=======
