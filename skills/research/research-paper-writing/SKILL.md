...
This skill is designed for the Sinoclaw agent. It uses Sinoclaw tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Sinoclaw skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.sinoclaw/plans/` | `skill_view("plan")` |
