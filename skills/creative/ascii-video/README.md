...
Built for [Sinoclaw Agent](https://github.com/NousResearch/sinoclaw-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/sinoclaw-agent/skills/creative/ascii-video`](https://github.com/NousResearch/sinoclaw-agent/tree/main/skills/creative/ascii-video) via PR.
