...
Built for [Sinoclaw Agent](https://github.com/sinoclaw/sinoclaw-agent). Usable in any coding agent. Canonical source lives here; synced to [`sinoclaw/sinoclaw-agent/skills/creative/ascii-video`](https://github.com/sinoclaw/sinoclaw-agent/tree/main/skills/creative/ascii-video) via PR.
